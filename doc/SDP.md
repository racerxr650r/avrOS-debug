...
> **Status: 🔲 In progress — issue [#55](https://github.com/racerxr650r/avrOS-debug/issues/55), branch `55-phase-19-dap-variables`.** Builds directly on the Phase-18 DWARF infrastructure (`elf_cfi_cfa`/`elf_var_addr`/`elf_addr_to_func`, the `dap_unwind` per-frame register model, `ElfFrameRegs`).
